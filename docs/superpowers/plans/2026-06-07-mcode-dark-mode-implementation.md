...
- `mcode-app/src/services/theme/themePreference.ts`
  Responsible for theme preference parsing, legacy migration, storage, startup application, and runtime theme helpers.
...
- [ ] **Step 1: Create the theme preference service**

Create [`themePreference.ts`](D:/Repos/xyito/lingyun/mcode/mcode-app/src/services/theme/themePreference.ts):
...
export function migrateLegacyThemePreference(
  ...
  if (typeof storedPreference === "string") return normalizeThemePreference(storedPreference)
...
- [ ] **Step 2: Enable runtime native theme sync**

Update [`main.ts`](D:/Repos/xyito/lingyun/mcode/mcode-app/src/main.ts):
...
- [ ] **Step 3: Replace the boolean startup dark-mode path**

Update [`App.vue`](D:/Repos/xyito/lingyun/mcode/mcode-app/src/App.vue):
...
Delete the old `initDarkMode()` function entirely.

- [ ] **Step 4: Commit the theme bootstrap work**
...
- [ ] **Step 1: Replace hardcoded page defaults with semantic variables**

Update the top of [`uni.scss`](D:/Repos/xyito/lingyun/mcode/mcode-app/src/uni.scss):
...
- [ ] **Step 2: Make the shared utility classes inherit semantic colors**
...
- [ ] **Step 3: Make the app root wrappers inherit semantic page background**
...
Update [`App.up.vue`](D:/Repos/xyito/lingyun/mcode/mcode-app/src/App.up.vue):
...
- [ ] **Step 1: Replace the boolean switch UI**
...
Replace the profile dark-mode state and handlers with:
...
- [ ] **Step 3: Preserve the new theme key during cache clearing**
...
- [ ] **Step 4: Convert profile page colors**
...
- [ ] **Step 5: Commit the profile work**
...
- [ ] **Step 1: Update the connections page**
...
- [ ] **Step 2: Update the conversations page**
...
- [ ] **Step 3: Update the conversation detail page**
...
- [ ] **Step 5: Commit the page theme pass**
...
- [ ] **Step 1: Make message bubbles token-driven**

In [`MessageBubble.vue`](D:/Repos/xyito/lingyun/mcode/mcode-app/src/components/MessageBubble.vue), replace:
...
- [ ] **Step 2: Make tool call and code blocks theme-aware**
...
- [ ] **Step 3: Align pet popup and panel surfaces**
...
Replace hardcoded dark-mode card backgrounds like:

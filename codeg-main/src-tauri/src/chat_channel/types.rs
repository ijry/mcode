...
pub struct McodeConfig {
    pub connection_mode: McodeConnectionMode,
...
impl std::fmt::Display for ChannelType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ChannelType::Mcode => write!(f, "mcode"),
        }
    }
}

impl std::fmt::Display for McodeConnectionMode {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            McodeConnectionMode::Relay => write!(f, "relay"),
            McodeConnectionMode::Direct => write!(f, "direct"),
        }
    }
}
